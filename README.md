...
| [Lesson 6 - Embed Liveboard](lesson-07-embed-liveboard/README-06.md)                | In this lesson we'll add code to to embed a liveboard and a liveboard visualization.                                                                                     |
| [Lesson 7 - Embed Application](lesson-09-embed-full-app/README-07.md)               | Finally, we'll embed the full ThoughtSpot application.                                                                                                                   |
| [Lesson 8 - Styling ThoughtSpot](lesson-10-style-embedded-thoughtspot/README-08.md) | In this lesson we'll take a look at some styling options when embedding ThoughtSpot into your application.                                                               |
...
| [Lesson 12 - Summary and Next Steps](lesson-11-summary/README-12.md)                | In this lesson, we wrap up the course with a few miscellaneous topics and some next steps.                                                                               |
